...
exports.sendPasswordResetEmailPasswordReset = void 0;
 ...
 */
const sendPasswordResetEmailPasswordReset = (email, username, randomPassword) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Construye la ruta absoluta del archivo de plantilla de correo electrónico
        const templatePath = path_1.default.join(__dirname, '..', '..', '..', '..', '..', '..', 'Auth', 'login', 'passwordRecovery', 'templates', 'randomPasswordEmail.html');
...
exports.sendPasswordResetEmailPasswordReset = sendPasswordResetEmailPasswordReset;
