...
exports.validateInputVerifyCodeResend = void 0;
 ...
 */
const validateInputVerifyCodeResend = (username, phoneNumber) => {
    const errors = [];
...
exports.validateInputVerifyCodeResend = validateInputVerifyCodeResend;
